...
var uploader = new plupload.Uploader({
    ...
    silverlight_xap_url: '${basePath}/plug-in/plupload/Moxie.xap', <#-- silverlight文件地址  -->
    filters: {
        max_file_size: "400mb", <#-- 最大上传文件大小（格式100b, 10kb, 10mb, 1gb）  -->
		// mime_types: [{title: "Common files", extensions:"exe,zip,txt,doc,docx,xls,xlsx,ppt,pdf,jpg,jpeg,png,gif"}],
		mime_types: [{title: "Common files", extensions:"*"}],
