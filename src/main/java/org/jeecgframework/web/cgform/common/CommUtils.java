...
import org.jeecgframework.web.cgform.controller.build.CgFormBuildController;
//xjz 20201023
...
//xjz 20201023
		...
		logger.info(String.valueOf(dataMap.size()));

		if(dataMap.size()==1)
		{
//			systemService.executeSql("delete from t_s_role_org where org_id=?", depart.getId());
//			systemService.executeSql("delete from jfrom_order_line");
